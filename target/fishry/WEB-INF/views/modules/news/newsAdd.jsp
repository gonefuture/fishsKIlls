...
<div class="container" id="box">
    <form role="form" action="<c:url value='/news?method=addNews'/>" method="post" enctype="multipart/form-data">
        <div>
            ...
            <div class="form-group">
                ...
                <input id="pic" type="file" name="picture"  class="form-control" placeholder="上传图片" />
            </div>
            
            <div class="form-group">
                <label for="dictionaryid">分类</label>
                <input id="dictionaryid" type="text" name="dictionaryid" class="form-control" placeholder="分类" />
            </div>
