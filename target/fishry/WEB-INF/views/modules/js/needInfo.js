const findNeedInfoPath = "/fishskills/Info?method=showInformation&dictionaryid=1711";
	...
	$.ajax({
		 ...
		 success : function(data, textStatus){
			...
			for(var i in list){
				...
				$(".rightTable table").append("<tr><td style='color:orange'>&#9830[供应信息]</td><td><a href='detail_needInfo.html?informationid="+list[i].informationid+" 'target='blank'>"+list[i].informationname+" </a></td> <td class='color-oran'>["+date+"]</td></tr>");
			} 
