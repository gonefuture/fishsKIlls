...
function setPath(){
	...
	$("#path2").text("");
	switch (optionChange) {
		case '2011':$("#path2").text("瑞宝钓鱼场");break;
		case '2012':$("#path2").text("七号钓虾场");break;
		case '2013':$("#path2").text("沙园钓虾场");break;
		case '2014':$("#path2").text("韩式钓虾场");break;
		case '2015':$("#path2").text("快活林钓虾场");break;
		case '2016':$("#path2").text("景业垂钓基地");break;
		case '2017':$("#path2").text("喜番茄钓虾");break;
	}
}
