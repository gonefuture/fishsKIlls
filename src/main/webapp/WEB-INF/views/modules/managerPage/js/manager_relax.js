...
function setPath(){
	...
	$("#path2").text("");
	switch (optionChange) {
		case '2111':$("#path2").text("美食保健");break;
		case '2112':$("#path2").text("水族馆");break;
		case '2113':$("#path2").text("观赏鱼");break;
		case '2114':$("#path2").text("休闲垂钓");break;
		case '2115':$("#path2").text("奇闻逸事");break;
	}
}
